...
import { Linking, Image, ScrollView, Text, View, Pressable } from 'react-native';
...
const Settings = ({ navigation }) => {
    ...
    const [values, setVlaues] = useState({name: "name", email: "user@mail.com"})
